...
const tableData = ref([
  { id: 1, permissionName: '系统管理', permissionCode: 'system', type: '菜单' },
  { id: 2, permissionName: '管理员管理', permissionCode: 'system:admin', type: '菜单' },
  { id: 3, permissionName: '商品管理', permissionCode: 'product', type: '菜单' }
])
</script>
